...
double coords:: radStr_2_deg(char rad[])
{
    bool b;
    b=1;
    //float r;
...
QString coords::radStr_2_degStr(char r[] )//hdhdjfj
{
...
QString coords::degStr_2_radStr(char d[])//452212
{
    string str(d);
    //QString qstr = QString::fromAscii(str);

    QString qstr1 = QString::fromStdString(str);
    QString qstr =rad_2_radStr(degStr_2_rad(qstr1));
    //QString qstr = QString::fromAscii(s);
